...
clean:
	...
	rm -f results/figs/EDA_TOUCH_TIME_lebron_james.png results/figs/EDA_SHOT_CLOCK_lebron_james.png results/figs/EDA_SHOT_NUMBER_lebron_james.png results/figs/EDA_SHOT_DIST_lebron_james.png results/figs/EDA_SHOT_RESULT_lebron_james.png results/figs/EDA_TOUCH_TIME__lebron_james.png results/figs/EDA_PERIOD_lebron_james.png results/figs/EDA_PTS_TYPE_lebron_james.png results/figs/EDA_DRIBBLES_lebron_james.png results/figs/EDA_CLOSE_DEF_DIST_lebron_james.png
