...
<br>
![alt tag](../results/figs/EDA_CLOSE_DEF_DIST_lebron_james.png)

### Figure 2. Number of Dribbles: 
<br>
![alt tag](../results/figs/EDA_DRIBBLES_lebron_james.png)

### Figure 3. Time on the Shot Clock (seconds): 
<br>
![alt tag](../results/figs/EDA_SHOT_CLOCK_lebron_james.png)

### Figure 4. Shot Distance (ft): 
<br>
![alt tag](../results/figs/EDA_SHOT_DIST_lebron_james.png)
...
<br>
![alt tag](../results/figs/train-test-acc_lebron james.png)

###  Figure 6. Top Three Features:
<br>
![alt tag](../results/figs/best_features_lebron james.png)
