...
```{r Closest Defender}
knitr::include_graphics("../results/figs/EDA_CLOSE_DEF_DIST_lebron_james.png")
```
...
```{r Dribbles}
knitr::include_graphics("../results/figs/EDA_DRIBBLES_lebron_james.png")
```
...
```{r shot clock}
knitr::include_graphics("../results/figs/EDA_SHOT_CLOCK_lebron_james.png")
```
...
```{r shot distance}
knitr::include_graphics("../results/figs/EDA_SHOT_DIST_lebron_james.png")
```
...
<br> 
```{r train test acc}
knitr::include_graphics("../results/figs/train-test-acc_lebron_james.png")
```
...
```{r best ft}
knitr::include_graphics("../results/figs/best_features_lebron_james.png")
```
